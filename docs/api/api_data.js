define({ "api": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "metaData",
            "description": "<p>Metadata object (if available)</p>"
          },
          {
            "group": "Success 200",
            "type": "Object",
            "optional": true,
            "field": "internalData",
            "description": "<p>Internal metadata object (if available), not included for user-role requests</p>"
          },
          {
            "group": "Success 200",
            "type": "Boolean",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "metaData",
            "description": "<p>Optional metadata, must be an object or JSON formatted string</p>"
          },
          {
            "group": "Parameter",
            "type": "Object|String",
            "optional": true,
            "field": "internalData",
            "description": "<p>Optional metadata for internal use, must be an object or JSON formatted string. Not available for user-role tokens</p>"
          },
          {
            "group": "Parameter",
            "type": "Object",
  ...
  },
  {
    ...
    "version": "0.0.0",
    "filename": "lib/api/domainaccess.js",
    "groupTitle": "DomainAccess"
  },
  {
    "type": "get",
    "url": "/domainaccess/:tag/allow",
    "title": "List allowlisted domains",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "results.domain",
            "description": "<p>allowlisted domain name</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "title": "List blocklisted domains",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "results.domain",
            "description": "<p>blocklisted domain name</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "domain",
            "description": "<p>Domain name to allowlist for users/addresses that include this tag</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "field": "async",
            "defaultValue": "false",
            "description": "<p>Schedule deletion task</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "fromWhitelist",
            "description": "<p>A list of additional email addresses this user can send mail from. Wildcard is allowed.</p>"
          },
          {
            "group": "Success 200",
            "type": "String[]",
  ...
  },
  {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "webhook",
            "description": "<p>ID of the Webhook</p>"
          }
        ]
      }
    },
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i -XDELETE http://localhost:8080/webhooks/59ef21aef255ed1d9d790e81",
        "type": "curl"
      }
    ],
    "version": "0.0.0",
    "filename": "lib/api/webhooks.js",
    "groupTitle": "Webhooks"
  },
  {
    "type": "get",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "type",
            "description": "<p>Prefix or exact match. Prefix match must end with <code>&quot;.*&quot;</code>, eg <code>&quot;channel.*&quot;</code>. Use <code>&quot;*&quot;</code> for all types</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "results",
            "description": "<p>Webhook listing</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "results.id",
            "description": "<p>Webhooks unique ID (24 byte hex)</p>"
          },
          {
            "group": "Success 200",
            "type": "String[]",
            "optional": false,
            "field": "results.type",
            "description": "<p>An array of event types this webhook matches</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "results.user",
            "description": "<p>User ID or null</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:8080/webhooks",
        "type": "curl"
      }
    ],
    "version": "0.0.0",
  ...
  },
  {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "type",
            "description": "<p>An array of event types to match. For prefix match use <code>&quot;.*&quot;</code> at the end (eg. <code>&quot;user.*&quot;</code>) or <code>&quot;*&quot;</code> for all types</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "user",
            "description": "<p>User ID to match (only makes sense for user specific resources)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "url",
            "description": "<p>URL to POST data to</p>"
          }
        ]
      }
    },
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i -XPOST http://localhost:8080/webhooks \\\n-H 'Content-type: application/json' \\\n-d '{\n  \"type\": [\"dkim.created\", \"user.*\"],\n  \"url\": \"https://98f7ab80593b966da1fc1cf58ff79046.m.pipedream.net\"\n}'",
        "type": "curl"
      }
    ],
    "version": "0.0.0",
