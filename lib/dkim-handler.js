...
${Buffer.concat([Buffer.from('MC4CAQAwBQYDK2VwBCIEIA==', 'base64'), Buffer.from(privateKeyPem, 'base64')]).toString('base64')}
-----END PRIVATE KEY-----`;
            }
            ...
            if (publicKey.asymmetricKeyType === 'ed25519') {
                ...
                ed25519PublicKey = publicKey.export({ format: 'der', type: 'spki' }).subarray(12).toString('base64');
        ...
        if (ed25519PublicKey) {
            dkimData.ed25519PublicKey = ed25519PublicKey;
        }
        ...
        return {
            ...
            dnsTxt: {
                ...
                value: 'v=DKIM1;t=s;p=' + (dkimData.ed25519PublicKey || dkimData.publicKey.replace(/^-.*-$/gm, '').replace(/\s/g, ''))
            }
        };
    }
