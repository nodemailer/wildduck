...
class UserHandler {
    ...
    generateASP(user, data, callback) {
        ...
        if (hasAllScopes || scopeSet.size === allowedScopes.length) {
            ...
            scopes = Array.from(scopeSet).sort((a, b) => a.lcoaleCompare(b));
        }
    ...
    create(data, callback) {
        this.users.collection('users').findOne(
            ...
            (err, userData) => {
                ...
                disabledScopes = Array.from(scopeSet).sort((a, b) => a.lcoaleCompare(b));
    ...
    update(user, data, callback) {
        ...
        Object.keys(data).forEach(key => {
            ...
            if (key === 'disabledScopes') {
                ...
                $set.disabledScopes = Array.from(scopeSet).sort((a, b) => a.lcoaleCompare(b));
                updates = true;
                return;
            }
