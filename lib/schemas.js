...
const mongoCursorValidator = opts => {
...
module.exports = { sessSchema, sessIPSchema, pageNrSchema, nextPageCursorSchema, previousPageCursorSchema, tagStringSchema, pageLimitSchema };
