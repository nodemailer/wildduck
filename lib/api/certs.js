...
const { nextPageCursorSchema, previousPageCursorSchema, pageNrSchema, booleanSchema } = require('../schemas');
...
module.exports = (server, db) => {
    ...
    server.route({
        ...
        async handler(request) {
            ...
            let altNames = request.query.altNames;
    ...
    server.route({
        ...
        async handler(request) {
            ...
            let servername = tools.normalizeDomain(request.params.servername);
