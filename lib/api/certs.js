                    ...
                    200: {
                        ...
                        model: Joi.object({
                            ...
                            fingerprint: Joi.string()
                                ...
                                .description('Key fingerprint (SHA1)')
                                .example('59:8b:ed:11:5b:4f:ce:b4:e5:1a:2f:35:b1:6f:7d:93:40:c8:2f:9c:38:3b:cd:f4:04:92:a1:0e:17:2c:3f:f3'),
                            expires: Joi.date().required().example('2024-06-26T21:55:55.000Z'),
                            altNames: Joi.array()
                                .items(Joi.string().required())
                                .required()
                                .description('SAN servernames listed in the certificate')
    ...
    server.del(
        {
            ...
            validationObjs: {
                ...
                pathParams: {
                    certs: Joi.string().hex().lowercase().length(24).required().description('ID of the TLS certificate').example('609d201236d1d936948f23b1')
                },
                response: {
                    200: {
                        description: 'Success',
