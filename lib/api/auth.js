    ...
    server.route({
        ...
        options: {
            ...
            validate: {
                ...
                params: Joi.object({
                    user: Joi.string().hex().lowercase().length(24).required().description('User ID').example('5ea82073daa6540db24dece6')
                    ...
                    results: Joi.array()
                        .items(
                            Joi.object({
                                ...
                                ip: sessIPSchema,
                                last: Joi.string().isoDate().example('2021-12-03T15:52:10.467Z').description('Last occurance of this event'),
