...
module.exports = (db, server, userHandler) => {
     ...
     * @apiParam {Object|String} [metaData] Optional metadata, must be an object or JSON formatted string
     * @apiParam {Object|String} [internalData] Optional metadata for internal use, must be an object or JSON formatted string. Not available for user-role tokens
     *
     * @apiSuccess {Boolean} success Indicates successful response
     ...
     * @apiSuccess {Object} [results.metaData] Metadata object (if available)
     * @apiSuccess {Object} [results.internalData] Internal metadata object (if available), not included for user-role requests
     *
     * @apiError error Description of the error
     *
     * @apiExample {curl} Example usage:
     ...
     * @apiSuccess {Object} [metaData] Metadata object (if available)
     * @apiSuccess {Object} [internalData] Internal metadata object (if available), not included for user-role requests
