...
const { GetAddressesResult, GetUserAddressesResult } = require('../schemas/response/addresses-schemas');
const { userId, addressEmail } = require('../schemas/request/general-schemas');
