...
const { GetAddressesResult, GetUserAddressesResult, GetUserAddressesregisterResult } = require('../schemas/response/addresses-schemas');
    ...
    server.post(
        {
            ...
            validationObjs: {
                ...
                response: {
                    200: {
                        description: 'Success',
                        model: Joi.object({ success: successRes, id: addressId })
                    }
                }
            }
        },
