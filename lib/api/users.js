...
module.exports = (db, server, userHandler) => {
     ...
     * @apiParam {Boolean} [allowUnsafe=true] If <code>false</code> then validates provided passwords against Have I Been Pwned API. Experimental, so disabled by default but will be enabled automatically in some future version.
