    ...
    server.route({
        ...
        options: {
            ...
            validate: {
                ...
                params: Joi.object({
                    user: userIdSchema.required()
                }).label('UserQuotaResetParams'),

                payload: Joi.object({
                    sess: sessSchema,
                    ip: sessIPSchema
                }).label('UserQuotaResetPayload')
            },
    ...
    server.route({
        ...
        options: {
            ...
            validate: {
                ...
                params: Joi.object({
                    user: userIdSchema.required()
                }).label('RestoreUserInfoParams'),

                query: Joi.object({
                    sess: sessSchema,
                    ip: sessIPSchema
                }).label('RestoreUserInfoQuery')
            },
