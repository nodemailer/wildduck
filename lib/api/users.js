            ...
            validate: {
                ...
                payload: Joi.object({
                    ...
                    language: Joi.string()
                        ...
                        .max(20)
                        .example('et')
                        .description('Language identifier. Will be used to generate localized special use mailbox folders.'),

                    retention: Joi.number().min(0).default(0).example(0).description('Default retention time (in ms). Set to 0 to disable.'),
