    ...
    server.get(
        {
            ...
            validationObjs: {
                ...
                queryParams: {
                    ...
                    internalData: booleanSchema.description('f true, then includes internalData in the response. Not shown for user-role tokens.'),
    ...
    server.post(
        {
            ...
            validationObjs: {
                requestBody: {
                    ...
                    imapMaxConnections: Joi.number().min(0).default(0).description('How many parallel IMAP connections are alowed'),
                        ...
                        model: Joi.object({
                            ...
                            limits: Joi.object({
                                ...
                                imapMaxConnections: Joi.object({
                                    ...
                                    used: Joi.number().required().description('How many parallel IMAP connections are currenlty in use')
                                })
                                    .description('a')
    ...
    server.put(
        {
            ...
            validationObjs: {
                requestBody: {
                    ...
                    imapMaxConnections: Joi.number().min(0).description('How many parallel IMAP connections are alowed'),
