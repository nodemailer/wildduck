...
describe('IMAP Protocol integration tests', function () {
    ...
    describe('AUTHENTICATE PLAIN', function () {
        it('should authenticate', function (done) {
            let cmds = [
                ...
                new Buffer('\x00testuser\x00pass', 'utf-8').toString('base64'),
                'T2 LOGOUT'
            ];
        ...
        it('should authenticate using SASL-IR', function (done) {
            let cmds = [
                'T1 AUTHENTICATE PLAIN ' + new Buffer('\x00testuser\x00pass', 'utf-8').toString('base64'),
                'T2 LOGOUT'
            ];
        ...
        it('should fail authentication', function (done) {
            let cmds = [
                'T1 AUTHENTICATE PLAIN',
                new Buffer('\x00testuser\x00wrongpass', 'utf-8').toString('base64'),
                'T2 LOGOUT'
            ];
    ...
    describe('LIST', function () {
        it('should list all mailboxes', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* LIST /mg).length).to.equal(3);
        ...
        it('should list first level mailboxes', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* LIST /mg).length).to.equal(2);
                expect(resp.indexOf('\r\n* LIST (\\HasNoChildren) "/" "INBOX"\r\n') >= 0).to.be.true;
                expect(resp.indexOf('\r\n* LIST (\\Noselect \\HasChildren) "/" "[Gmail]"\r\n') >= 0).to.be.true;
                expect(/^T2 OK/m.test(resp)).to.be.true;
                done();
    ...
    describe('LSUB', function () {
        it('should list all mailboxes', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* LSUB /mg).length).to.equal(2);
        ...
        it('should list first level mailboxes', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* LSUB /mg).length).to.equal(1);
                expect(resp.indexOf('\r\n* LSUB (\\HasNoChildren) "/" "INBOX"\r\n') >= 0).to.be.true;
                expect(/^T2 OK/m.test(resp)).to.be.true;
                done();
            });
    ...
    describe('STATUS', function () {
        it('should error on nonexistent mailbox', function (done) {
            let cmds = [
                'T1 LOGIN testuser pass',
                'T2 STATUS zzz (UIDNEXT MESSAGES)',
                'T3 LOGOUT'
            ];
        ...
        it('should return status response', function (done) {
            let cmds = [
                'T1 LOGIN testuser pass',
                'T2 STATUS INBOX (UIDNEXT MESSAGES HIGHESTMODSEQ)',
                'T3 LOGOUT'
            ];
    ...
    describe('STORE', function () {
        it('should set flags', function (done) {
            let cmds = [
                'T1 LOGIN testuser pass',
                'T2 SELECT INBOX',
                'T3 STORE 1:* FLAGS (MyFlag1 MyFlag2)',
                'T4 LOGOUT'
            ];
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* \d+ FETCH \(FLAGS \(MyFlag1 MyFlag2\)\)$/mg).length).to.equal(6);
                expect(/^T3 OK/m.test(resp)).to.be.true;
                done();
            });
        });
        ...
        it('should add flags', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* \d+ FETCH \(FLAGS \(MyFlag1 MyFlag2\)\)$/mg).length).to.equal(4);
                expect(resp.match(/^\* \d+ FETCH \(FLAGS \(\\Seen MyFlag1 MyFlag2\)\)$/mg).length).to.equal(2);
                expect(/^T3 OK/m.test(resp)).to.be.true;
                done();
            });
        });
        ...
        it('should remove flags', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* \d+ FETCH \(FLAGS \(\)\)$/mg).length).to.equal(2);
                expect(/^T3 OK/m.test(resp)).to.be.true;
                done();
            });
        });
        ...
        it('should set some flags with modifier', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* \d+ FETCH \(FLAGS \(MyFlag1 MyFlag2\) MODSEQ \(\d+\)\)$/mg).length).to.equal(4);
        ...
        it('should set flags with modifier', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* \d+ FETCH \(FLAGS \(MyFlag1 MyFlag2\) MODSEQ \(\d+\)\)$/mg).length).to.equal(6);
    ...
    describe('UID STORE', function () {
        it('should set flags', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* \d+ FETCH \(UID \d+ FLAGS \(MyFlag1 MyFlag2\)\)$/mg).length).to.equal(6);
                expect(/^T3 OK/m.test(resp)).to.be.true;
                done();
            });
        });
        ...
        it('should add flags', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* \d+ FETCH \(UID \d+ FLAGS \(MyFlag1 MyFlag2\)\)$/mg).length).to.equal(4);
                expect(resp.match(/^\* \d+ FETCH \(UID \d+ FLAGS \(\\Seen MyFlag1 MyFlag2\)\)$/mg).length).to.equal(2);
                expect(/^T3 OK/m.test(resp)).to.be.true;
                done();
            });
        });
        ...
        it('should remove flags', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* \d+ FETCH \(UID \d+ FLAGS \(\)\)$/mg).length).to.equal(2);
                expect(/^T3 OK/m.test(resp)).to.be.true;
                done();
            });
        });
        ...
        it('should set some flags with modifier', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* \d+ FETCH \(UID \d+ FLAGS \(MyFlag1 MyFlag2\) MODSEQ \(\d+\)\)$/mg).length).to.equal(4);
                expect(/\[MODIFIED [\d,:]+\]/.test(resp)).to.be.true;
                expect(/^T3 OK/m.test(resp)).to.be.true;
                done();
            });
        ...
        it('should set some flags with modifier', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* \d+ FETCH \(UID \d+ FLAGS \(MyFlag1 MyFlag2\) MODSEQ \(\d+\)\)$/mg).length).to.equal(6);
                expect(/MODIFIED/.test(resp)).to.be.false;
                expect(/^T3 OK/m.test(resp)).to.be.true;
                done();
            });
    ...
    describe('SUBSCRIBE', function () {
        it('should subscribe to mailbox', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* LSUB /mg).length).to.equal(3);
                expect(resp.indexOf('\r\n* LSUB (\\HasNoChildren) "/" "INBOX"\r\n') >= 0).to.be.true;
                expect(resp.indexOf('\r\n* LSUB (\\HasNoChildren) "/" "[Gmail]/Sent Mail"\r\n') >= 0).to.be.true;
    ...
    describe('EXPUNGE', function () {
        it('should expunge messages', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* 2 EXPUNGE/mg).length).to.equal(5);
                expect(/^T4 OK/m.test(resp)).to.be.true;
                done();
            });
        });
    ...
    describe('UID EXPUNGE', function () {
        it('should expunge messages', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* \d+ EXPUNGE/mg).length).to.equal(1);
                expect(resp.match(/^\* 3 EXPUNGE/mg).length).to.equal(1);
                expect(/^T4 OK/m.test(resp)).to.be.true;
                done();
            });
        });
    ...
    describe('FETCH command', function () {
        ...
        it('should list with MODSEQ', function (done) {
            ...
            testClient({
                ...
                expect(resp.match(/^\* \d+ FETCH/mg).length).to.equal(2);
                expect(/^T3 OK/m.test(resp)).to.be.true;
                expect(/^T4 OK/m.test(resp)).to.be.true;
        ...
        describe('Multiple values', function () {
            it('should list mixed data', function (done) {
                ...
                testClient({
                    ...
                    resp = resp.toString();
                    expect(resp.slice(/\n/).indexOf('* 1 FETCH (UID 45 BODYSTRUCTURE ("TEXT" "PLAIN" NIL NIL NIL "7BIT" 4 1 NIL NIL NIL NIL) ENVELOPE (NIL "test" ((NIL NIL "sender" "example.com")) ((NIL NIL "sender" "example.com")) ((NIL NIL "sender" "example.com")) ((NIL NIL "to" "example.com")) ((NIL NIL "cc" "example.com")) NIL NIL NIL))') >= 0).to.be.true;
                    expect(/^T3 OK/m.test(resp)).to.be.true;
                    done();
                });
            });
        ...
        describe('BODYSTRUCTURE', function () {
            it('should list bodystructure object', function (done) {
                ...
                testClient({
                    ...
                    resp = resp.toString();
                    expect(resp.indexOf('\n* 3 FETCH (BODYSTRUCTURE (("MESSAGE" "RFC822" NIL NIL NIL "7BIT" 107 (NIL "" ((NIL NIL "andris" "kreata.ee")) ((NIL NIL "andris" "kreata.ee")) ((NIL NIL "andris" "kreata.ee")) ((NIL NIL "andris" "pangalink.net")) NIL NIL "<test1>" NIL) ("TEXT" "PLAIN" NIL NIL NIL "7BIT" 14 1 NIL NIL NIL NIL) 6 NIL NIL NIL NIL) ("MESSAGE" "RFC822" NIL NIL NIL "7BIT" 85 (NIL "" ((NIL NIL "andris" "kreata.ee")) ((NIL NIL "andris" "kreata.ee")) ((NIL NIL "andris" "kreata.ee")) ((NIL NIL "andris" "pangalink.net")) NIL NIL NIL NIL) ("TEXT" "PLAIN" NIL NIL NIL "7BIT" 14 1 NIL NIL NIL NIL) 5 NIL NIL NIL NIL) ("TEXT" "HTML" ("CHARSET" "utf-8") NIL NIL "QUOTED-PRINTABLE" 21 1 NIL NIL NIL NIL) "MIXED" ("BOUNDARY" "----mailcomposer-?=_1-1328088797399") NIL NIL NIL))\r\n') >= 0).to.be.true;
                    expect(/^T3 OK/m.test(resp)).to.be.true;
                    done();
                });
            });
        ...
        describe('BODY', function () {
            it('should return BODY', function (done) {
                ...
                testClient({
                    ...
                    resp = resp.toString();
                    expect(resp.indexOf('\n* 1 FETCH (BODY ("TEXT" "PLAIN" NIL NIL NIL "7BIT" 4 1))\r\n') >= 0).to.be.true;
                    expect(/^T3 OK/m.test(resp)).to.be.true;
                    done();
                });
            });
    ...
    describe('SEARCH command', function () {
        it('should succeed', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* SEARCH /mg).length).to.equal(2);
                expect(/^T3 OK/m.test(resp)).to.be.true;
                expect(/^T4 OK/m.test(resp)).to.be.true;
                done();
            });
        ...
        it('should find with MODSEQ', function (done) {
            ...
            testClient({
                ...
                resp = resp.toString();
                expect(resp.match(/^\* SEARCH /mg).length).to.equal(1);
